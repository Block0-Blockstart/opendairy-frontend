    ...
    <Box
      ...
      <Box display={'flex'} flexDirection={'column'} rowGap={'1rem'}>
        <Typography mb={'1rem'} variant={'body'}>
          The document of type <b>{'" ' + dr.documentType + ' "'}</b>, that we submitted on{' '}
          <b>{toIsoDate(dr.documentDelivery.sentDate)}</b>, has been accepted by the recipient.
        </Typography>
        ...
        <Typography mb={'1rem'} variant={'body'}>
          Do you want to download a certified copy of the approved document?
        </Typography>
      </Box>
